...
def train_hf_ds(batch_size=64, epochs=100, lr=3e-8, checkpt_freq=10, tb_comment=''):
    ...
    optimizer, lr_scheduler = train_test_model.get_optimzer(initial_lr=lr, model=model)
